...
//    __SC1_ID_DCU,
    ...
    __SET_OPTION_CH1_TITLE,
    __SET_OPTION_CH1_PH,
    __SET_OPTION_CH1_CLO,
    __SET_OPTION_CH1_EC,
    __SET_OPTION_CH1_TURB,
    __SET_OPTION_CH1_COD,
    
    __SET_OPTION_CH1_TITLE_2,
    __SET_OPTION_CH1_TSS,
    __SET_OPTION_CH1_NH4,
    __SET_OPTION_CH1_DO,
    __SET_OPTION_CH1_SALT,
    __SET_OPTION_CH1_TDS,
    ...
    __SET_OPTION_CH2_PH,
    __SET_OPTION_CH2_CLO,
    __SET_OPTION_CH2_EC,
    __SET_OPTION_CH2_TURB,
    __SET_OPTION_CH2_COD,
    
    __SET_OPTION_CH2_TITLE_2,
    __SET_OPTION_CH2_TSS,
    __SET_OPTION_CH2_NH4,
    __SET_OPTION_CH2_DO,
    __SET_OPTION_CH2_SALT,
    __SET_OPTION_CH2_TDS,
...
typedef enum
{
    ...
    _LCD_SCR_SET_OPTION_SS_CH1,
    _LCD_SCR_SET_OPTION_SS_CH1_TAB_2,
    _LCD_SCR_SET_OPTION_SS_CH1_TAB_3,
    _LCD_SCR_SET_OPTION_SS_CH2,
    _LCD_SCR_SET_OPTION_SS_CH2_TAB_2,
    _LCD_SCR_SET_OPTION_SS_CH2_TAB_3,
    _LCD_SCR_CHECK_SETTING,
    
    _LCD_SCR_CHANGE_PASS,
