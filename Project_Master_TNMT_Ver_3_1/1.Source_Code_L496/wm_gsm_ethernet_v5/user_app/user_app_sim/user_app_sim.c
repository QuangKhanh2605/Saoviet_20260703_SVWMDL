...
//            sSimCommVar.pSender.Length_u16 = sMessage.str.Length_u16;
        ...
        case _SIM_COMM_MQTT_CONN_1:
            ...
            sSimCommVar.pSender.Data_a8 = sMessage.sConnect.Data_a8;
            sSimCommVar.pSender.Length_u16 = sMessage.sConnect.Length_u16;
        ...
        case _SIM_COMM_MQTT_SUB_1:
            ...
            sSimCommVar.pSender.Data_a8 = sMessage.sSubcribe.Data_a8;
...
void AppSim_Test_FTP_Init (void)
{
    ...
    UTIL_MEM_set(&sModemVar.sFwUpdate.sServer, 0, sizeof(sModemVar.sFwUpdate.sServer));
    UTIL_MEM_set(&sModemVar.sFwUpdate.aPATH, 0, sizeof(sModemVar.sFwUpdate.aPATH));
    ...
    if (strlen(sModemInfor.sServerTn.sServer.aIP) == 0) {
        ...
        UTIL_MEM_cpy(&sModemVar.sFwUpdate.aPATH, &sModemInfor.sServerTn.aPATH, sizeof(sModemInfor.sServerTn.aPATH) );
    }
    
    if (sWmVar.ModePacket_u8 == 2) {
        uint32_t id = (sModemInfor.aID[strlen(sModemInfor.aID)-2] - 0x30 ) * 10 
                        + (sModemInfor.aID[strlen(sModemInfor.aID)-1] - 0x30);
                           
        sSimCommVar.TimeRandID_u32 = (id * 2) % MAX_TIME_RAND_ID;
    }
}
