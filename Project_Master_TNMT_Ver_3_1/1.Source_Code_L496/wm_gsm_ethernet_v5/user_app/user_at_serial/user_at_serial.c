...
//			id ENUM		    kind process		  str Received
    ...
    {_SET_PULSE_FACTOR, 	NULL,		    {(uint8_t*)"at+pulsef=",10}},       
    {_QUERY_PULSE_FACTOR, 	NULL,           {(uint8_t*)"at+pulsef?",10}},

    {_SET_PULSE_START, 		NULL,		    {(uint8_t*)"at+pulses=",10}},        
    {_QUERY_PULSE_START, 	NULL,           {(uint8_t*)"at+pulses?",10}},
    ...
    {_SET_LEVEL_INFOR,	    NULL,	        {(uint8_t*)"at+level=",9}},     //at+level=1,3000,2860
    {_QUERY_LEVEL_INFOR,	NULL,	        {(uint8_t*)"at+level?",9}},
    
    {_QUERY_PRESS_VAL,	    NULL,	        {(uint8_t*)"at+press?",9}},
    {_QUERY_PRESS_CALIB,	NULL,	        {(uint8_t*)"at+presscalib?",14}},
    {_QUERY_PRESS_CAL_VAL,	NULL,	        {(uint8_t*)"at+presscalibval?",17}},
    
    {_SET_MODEM_RESET,	    NULL,	        {(uint8_t*)"at+creset=",10}},      // at+creset=0
    {_QUERY_MODEM_RESET,	NULL,	        {(uint8_t*)"at+creset?",10}},
    
    {_SET_TIME_ALARM, 		NULL,		    {(uint8_t*)"at+talarm=",10}},      // at+talarm=300 (s)
    {_QUERY_TIME_ALARM, 	NULL,           {(uint8_t*)"at+talarm?",10}},
    
    {_SET_TNMT_INFOR, 		NULL,		    {(uint8_t*)"at+chaninfor=",13}},  //at+chaninfor=6,HY|PHONOI|GY3|2,0,1
    {_QUERY_TNMT_INFOR, 	NULL,           {(uint8_t*)"at+chaninfor?",13}},
    ...
    {_GET_MOD_TCP_MAIN,     NULL,           {(uint8_t*)"at+modtcpmain?",14}},
    {_SET_MOD_TCP_MAIN,     NULL,           {(uint8_t*)"at+modtcpmain=",14}},
    
    {_GET_SEND_GPS,         NULL,           {(uint8_t*)"at+sendgps?",11}},
