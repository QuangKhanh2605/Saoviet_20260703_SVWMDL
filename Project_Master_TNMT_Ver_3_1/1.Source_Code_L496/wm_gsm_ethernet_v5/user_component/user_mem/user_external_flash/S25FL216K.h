...
#define FLASH_S25FL_END 	            0x01000000      //16 Mbyte = 128 Mbit:   4096 secor 4k

#define FLASH_ADDR_MODB_INFOR 		    0x001000		//Sector 1
#define FLASH_ADDR_METER_NUM 		    0x002000		//Sector 2
#define	FLASH_ADDR_WM_CONFIG			0x003000        //Sector 3
#define	FLASH_ADDR_INDEX_REC 		    0x004000        //Sector 4

#define FLASH_ADDR_EVENT_START 		    0x00A000		//Sector 10
#define FLASH_ADDR_EVENT_STOP			0x00F000		//Sector 15 

#define FLASH_ADDR_LOG_START 			0x010000		//Sector 16		
#define FLASH_ADDR_LOG_STOP				0x030000		//Sector 48  

#define FLASH_ADDR_TSVH_START 		    0x030000		//Sector 48   
...
uint8_t eFlash_S25FL_Erase_Chip(void);
