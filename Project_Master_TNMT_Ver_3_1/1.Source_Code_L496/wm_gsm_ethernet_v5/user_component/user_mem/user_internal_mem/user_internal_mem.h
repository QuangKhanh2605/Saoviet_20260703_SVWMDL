...
#define BOARD_READ_PULSE
...
#ifdef BOARD_LC_V1_0
    #define ADDR_MAIN_PROGRAM           0x08004000            //55 Page cho chuong trinh chinh = 110k = 1B800
    #define ADDR_UPDATE_PROGRAM         0x0801F800            //55 page -> End Program = 0x0803B000
          
    /*========Add Record Mess ================ */
    #define	ADDR_MESS_A_START   		0x0803B000	         //k dung
    #define	ADDR_MESS_A_STOP			0x0803B800

    #define	ADDR_EVENT_START   		    0x0803B800	         //k dung
    #define	ADDR_EVENT_STOP			    0x0803C000

    #define	ADDR_LOG_START   		    0x0803C000	         //k dung
    #define	ADDR_LOG_STOP			    0x0803C800           
    
    #define	ADDR_GPS_START   		    0x0803C800	        
    #define	ADDR_GPS_STOP			    0x0803C800           

    /*=======Add Index Mess================ */
    #define	ADDR_INDEX_REC 		        0x0803C800
    /* ============= Addr Meter config======== */  
    #define	ADDR_PRESS_INFOR			0x0803D000
    #define	ADDR_THRESH_MEAS			0x0803D000	
    #define	ADDR_METER_NUMBER			0x0803D800
    #define ADDR_MODEM_INFOR    	    0x0803F000      

    #define ADDR_FLAG_HAVE_NEW_FW       0x0803F800

    #define	FLASH_MAX_MESS_TSVH_SAVE	30
    #define	FLASH_MAX_MESS_EVENT_SAVE   2
    #define FLASH_MAX_MESS_LOG_SAVE     30

    #define MAX_SIZE_FIRMWARE           110     //Kb
    #define FIRMWARE_SIZE_PAGE	        MAX_SIZE_FIRMWARE*1024/FLASH_PAGE_SIZE

    #define SIZE_DATA_TSVH	            64        
    #define SIZE_DATA_EVENT	            64         
    #define SIZE_DATA_LOG	            64 

#else
    #define	ADDR_MAIN_PROGRAM			0x08004000	        //59 Page cho chuong trinh chinh = 118k = 1D800
    #define	ADDR_UPDATE_PROGRAM			0x08021800	        //59 page -> End Program = 0x0803F000

    /*========Add Record Mess ================ */
    #define	ADDR_MESS_A_START   		0x0803F800	         //k dung
    #define	ADDR_MESS_A_STOP			0x0803F800

    #define	ADDR_EVENT_START   		    0x0803F800	         //k dung
    #define	ADDR_EVENT_STOP			    0x0803F800

    #define	ADDR_LOG_START   		    0x0803F800	         //k dung
    #define	ADDR_LOG_STOP			    0x0803F800           
    
    #define	ADDR_GPS_START   		    0x0803F800	        
    #define	ADDR_GPS_STOP			    0x0803F800           

    /*=======Add Index Mess================ */
    #define	ADDR_INDEX_REC 		        0x0803F800
    /* ============= Addr Meter config======== */  
    #define	ADDR_PRESS_INFOR			0x0803F800
    #define	ADDR_THRESH_MEAS			0x0803F800	
    #define	ADDR_METER_NUMBER			0x0803F800
    #define ADDR_MODEM_INFOR    	    0x0803F000      
    #define ADDR_FLAG_HAVE_NEW_FW       0x0803F800

    #define	FLASH_MAX_MESS_TSVH_SAVE	15
    #define	FLASH_MAX_MESS_EVENT_SAVE   2
    #define FLASH_MAX_MESS_LOG_SAVE     30

    #define MAX_SIZE_FIRMWARE           118     //Kb
    #define FIRMWARE_SIZE_PAGE	        MAX_SIZE_FIRMWARE*1024/FLASH_PAGE_SIZE
    ...
    #define	ADDR_GPS_START   		    0x08080000	         //256k = 2048 rec * 128  0x08080000->0x080C0000
    #define	ADDR_GPS_STOP			    0x080C0800           
    ...
    #define	ADDR_PRESS_INFOR			0x0807E000
    #define	ADDR_THRESH_MEAS			0x0807E000	
    #define	ADDR_METER_NUMBER			0x0807E800

    #define ADDR_MODEM_INFOR    	    0x0807F000      
    #define ADDR_FLAG_HAVE_NEW_FW       0x0807F800
    ...
    #define ADDR_SAVE_PASSWORD          0x08082000

    #define ADDR_OFFSET_MEASURE         0x0808F000
    #define ADDR_USER_SENSOR            0x0808F800
