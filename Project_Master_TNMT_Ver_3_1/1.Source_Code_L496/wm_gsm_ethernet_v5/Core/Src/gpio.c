...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, SIM_ON_OFF_Pin|SIM_DTR_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DEV_DO_4_Pin|DEV_DO_3_Pin|DEV_DO_2_Pin|DEV_DO_1_Pin
  ...
  /*Configure GPIO pin : SIM_RESET_Pin */
  ...
  /*Configure GPIO pins : ETH2_RSTn_Pin OPTIGA_RESET_Pin */
  GPIO_InitStruct.Pin = ETH2_RSTn_Pin|OPTIGA_RESET_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);
  ...
  GPIO_InitStruct.Pin = SD_IN_Pin|BUTTON_PRESS_1_Pin|BUTTON_PRESS_2_Pin|BUTTON_PRESS_3_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOD, &GPIO_InitStruct);
